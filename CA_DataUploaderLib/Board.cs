...
namespace CA_DataUploaderLib
{
    public class Board
    {
        ...
        public override string ToString() => $"Product Type: {ProductType,-20}  Sub Product Type: {SubProductType,-3} Serial Number: {SerialNumber,-12} Port name: {PortName,-18} PCB version: {PcbVersion}";
