...
namespace CA_DataUploaderLib.IOconf
{
    public sealed class IOconfExpand : IOconfRow
    {
        ...
        {
            Format = $"{ConfigName};name1;name2;...;namen;-;rowstartshere;$name{Environment.NewLine}{ConfigName};tagfields:mytag;suffix:mysuffix;rowstartshere;$name";
            ExpandsTags = true;
            var list = ToList();
        ...
        protected internal override IEnumerable<string> GetExpandedConf()
        {
